  ...
  return (
    <div className="px-8 pb-8 my-16 lg:pb-16 bg-sugar-pink-100 lg:px-16">
      <div className="container relative pt-16">
        <h2 className=""><a rel="noopener noreferrer" target="_blank" href="https://www.instagram.com/zuckermaus_bakery/" className="inline-flex gap-2 flex-row items-center hover:text-red-500 focus:text-red-500">Instagram <AiFillInstagram  /></a></h2>
        <div className="flex flex-col sm:grid sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {insta.allInstagramContent.edges.map(({ node: instapost }) => (
            <a
              ...
              className="hover:bg-rose-pink-300 focus:bg-rose-pink-300 pb-4"
              target="_blank"
            >
              ...
              <div className="p-8 text-xs lg:pb-0">
                <span className="text-2xs block mb-4">{ instapost.timestamp }</span>
                {instapost.caption}
                <svg
